...
@NamedQueries({
    ...
    @NamedQuery(name = "AccessLogs.findByLocation", query = "SELECT a FROM AccessLogs a WHERE a.location = :location"),
...
public class AccessLogs implements Serializable {
    ...
    public AccessLogs(Integer logId, Date accessTime, boolean accessGranted) {
        this.logId = logId;
    ...
    public void setAccessId(AccessRoom accessId) {
